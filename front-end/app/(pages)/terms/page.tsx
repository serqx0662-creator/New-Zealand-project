...
export default function TermsPage() {
    ...
    const sections = Object.keys(t)
        .filter(key => key.startsWith('section') && key.endsWith('Title'))
        .map(titleKey => {
            const index = titleKey.replace('section', '').replace('Title', '');
            return {
                title: t[titleKey as keyof typeof t] as string,
                text: t[`section${index}Text` as keyof typeof t] as string
            };
        });
            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed border-l-2 border-purple-600 pl-4 py-2 bg-purple-50/40 rounded-r-xl">
                            {t.intro}
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-7 space-y-5">
                        {sections.map((section, index) => (
                            <div
                                key={index}
                                className="p-6 bg-gray-50/60 border border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50/90 transition-all"
                            >
